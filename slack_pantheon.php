...
// $pretext array added by IM 2017-06-02
$pretext = [
  'sync_code' => 'Committed! :thumbsup:',
  'clear_cache' => 'Caches cleared :construction:',
  'deploy' => 'Deployed :rocket:'
];
$attachment = [
  'fallback' => $text,
  'pretext' => (isset($pretext[$_POST['wf_type']]) ? $pretext[$_POST['wf_type']] : $pretext['deploy']),
  'color' => $project_colour, // Can either be one of 'good', 'warning', 'danger', or any hex color code
  'fields' => $fields
  ];
